...
const $fragment3 = parseFragment`<div class="slds-spinner__dot-a${0}"${2}></div>`;
const $fragment4 = parseFragment`<div class="slds-spinner__dot-b${0}"${2}></div>`;
const stc0 = {
  classMap: {
...
function tmpl($api, $cmp, $slotset, $ctx) {
  ...
  }), $cmp.showDropdownActivityIndicator ? api_element("div", stc19, [api_element("div", stc20, [api_element("div", stc21, [api_element("span", stc22, [api_text(api_dynamic_text($cmp.i18n.loadingText))]), api_static_fragment($fragment3(), 34), api_static_fragment($fragment4(), 36)])])]) : null, $cmp.showAttribution ? api_element("div", stc23, [api_element("img", {
    classMap: stc24,
    attrs: {
